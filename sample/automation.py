...
while True:
    ...
    if scene == 1:
        ...
        if len(enemies) != 0:
            ...
            elif is_shot == False and p_x + p_width/2 + p_laser_width/2 > closest_enemy[0] and p_x + p_width/2 - p_laser_width/2 < closest_enemy[0] + e_width:
